...
execute store result storage ic:mob health double 1.1 run random value 50..100
execute store result storage ic:mob attack double 0.1 run random value 50..80
execute store result storage ic:mob speed double 0.0075 run random value 45..60
...
execute if score $mainhand ic.int matches 1 run data modify storage ic:mob mainhand set value '{id:"minecraft:iron_sword",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:sharpness":2}}}}'
execute if score $mainhand ic.int matches 2 run data modify storage ic:mob mainhand set value '{id:"minecraft:iron_sword",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:knockback":1}}}}'
...
execute if score $offhand ic.int matches 2 run data modify storage ic:mob offhand set value '{id:"minecraft:iron_sword",count:1,components:{"minecraft:attribute_modifiers":[{id:"armor",type:"generic.attack_damage",amount:0.1,operation:"add_multiplied_base",slot:"offhand"}]}}'
...
execute if score $offhand ic.int matches 4 run data modify storage ic:mob offhand set value '{id:"minecraft:goat_horn",count:1,components:{"minecraft:attribute_modifiers":[{id:"armor",type:"generic.attack_knockback",amount:4,operation:"add_value",slot:"offhand"}]}}'
