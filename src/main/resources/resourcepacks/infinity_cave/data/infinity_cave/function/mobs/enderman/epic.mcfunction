...
execute store result storage ic:mob health double 1.2 run random value 60..120
...
data modify storage ic:mob mainhand set value '{id:"minecraft:stone_sword",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:sharpness":2}}}}'
