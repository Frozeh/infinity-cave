...
data modify storage ic:mob mainhand set value '{id:"minecraft:trident",count:1,components:{"minecraft:custom_data":{ic:lightning_trident},"minecraft:enchantments":{levels:{"minecraft:sharpness":5}}}}'
