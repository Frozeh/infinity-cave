...
summon item ~ ~ ~ {NoGravity:1b,Age:5700,PickupDelay:9999,Invulnerable:1b,Tags:["ic.magician_blizzard","ic.ability","ic.blizz_legendary"],Item:{id:"minecraft:snowball",count:1}}
