...
execute store result score ic.random ic.int run random value 1..109
...
execute if score ic.random ic.int matches 106..109 run function infinity_cave:mobs/rocklops/rare
