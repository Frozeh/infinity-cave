...
execute store result storage ic:alchemist dmg int 1 run random value 20..30

execute store result storage ic:alchemist mf int 1 run random value 0..2
execute store result storage ic:alchemist mf_d int 1 run random value 0..80
execute store result storage ic:alchemist n int 1 run random value 1..4
execute store result storage ic:alchemist n_d int 1 run random value 0..80
...
execute store result storage ic:alchemist h_d int 1 run random value 0..80
execute store result storage ic:alchemist wi int 1 run random value 0..2
execute store result storage ic:alchemist wi_d int 1 run random value 0..80
...
execute store result storage ic:alchemist p_d int 1 run random value 0..80
execute store result storage ic:alchemist l int 1 run random value 0..6
