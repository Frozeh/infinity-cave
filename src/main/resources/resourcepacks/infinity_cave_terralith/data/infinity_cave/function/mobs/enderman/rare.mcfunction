...
execute store result storage ic:mob health double 1.2 run random value 50..100
...
data modify storage ic:mob mob set value enderman
data modify storage ic:mob Name set value '{"text":"Enderman"}]'
