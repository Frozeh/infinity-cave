...
data modify storage ic:mob mainhand set value '{id:"minecraft:trident",count:1,components:{"minecraft:custom_data":{ic:lightning_trident},"minecraft:enchantments":{levels:{"minecraft:sharpness":15}}}}'

data modify storage ic:mob type set value "ic.ranged"

execute store result score $offhand ic.int run random value 1..2
