execute store result storage ic:mob health double 1.5 run random value 75..150
...
execute if score $offhand ic.int matches 4 run data modify storage ic:mob offhand set value '{id:"minecraft:goat_horn",count:1,components:{"minecraft:attribute_modifiers":[{id:"armor",type:"generic.attack_knockback",amount:10,operation:"add_value",slot:"offhand"}]}}'
