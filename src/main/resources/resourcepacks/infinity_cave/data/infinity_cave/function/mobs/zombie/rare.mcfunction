...
execute store result score $mainhand ic.int run random value 1..3

execute if score $mainhand ic.int matches 1 run data modify storage ic:mob mainhand set value '{id:"minecraft:iron_sword",count:1}'
execute if score $mainhand ic.int matches 2 run data modify storage ic:mob mainhand set value '{id:"minecraft:iron_pickaxe",count:1}'
execute if score $mainhand ic.int matches 3 run data modify storage ic:mob mainhand set value '{id:"minecraft:iron_shovel",count:1}'
