...
execute if score $mainhand ic.int matches 1 run data modify storage ic:mob mainhand set value '{id:"minecraft:diamond_sword",count:1}'
execute if score $mainhand ic.int matches 2 run data modify storage ic:mob mainhand set value '{id:"minecraft:diamond_pickaxe",count:1}'
execute if score $mainhand ic.int matches 3 run data modify storage ic:mob mainhand set value '{id:"minecraft:diamond_shovel",count:1}'
