...
execute if score $mainhand ic.int matches 2 run data modify storage ic:mob mainhand set value '{id:"minecraft:trident",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:sharpness":1}}}}'
