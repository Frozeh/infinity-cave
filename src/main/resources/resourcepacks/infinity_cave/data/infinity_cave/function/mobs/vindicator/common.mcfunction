...
execute store result storage ic:mob knockback double 0.0025 run random value 25..50
...
execute if score $mainhand ic.int matches 1 run data modify storage ic:mob mainhand set value '{id:"minecraft:wooden_axe",count:1}'
...
execute if score $offhand ic.int matches 4 run data modify storage ic:mob offhand set value '{id:"minecraft:goat_horn",count:1,tag:{AttributeModifiers:[{AttributeName:"generic.attack_knockback",Name:"generic.attack_knockback",Amount:2,Operation:0,UUID:[I;-210680987,-1774566054,-1842487822,-729322270]}]}}'
