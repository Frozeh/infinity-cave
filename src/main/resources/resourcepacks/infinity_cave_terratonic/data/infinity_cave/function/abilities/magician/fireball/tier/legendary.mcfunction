...
summon item ~ ~ ~ {NoGravity:1b,Age:5900,PickupDelay:9999,Invulnerable:1b,Tags:["ic.magician_fireball","ic.ability"],Passengers:[{id:"minecraft:area_effect_cloud",Particle:{type:"block",block_state:"minecraft:air"},ReapplicationDelay:0,Radius:1f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:100,DurationOnUse:0,Age:-200000,WaitTime:-200000,Tags:["ic.magician_fdmg","ic.ability","ic.legendary_fire"]}],Item:{id:"minecraft:blaze_powder",count:1}}
