...
execute store result storage ic:mob health double 2 run random value 25..50
...
execute store result storage ic:mob knockback double 0.01 run random value 50..100
