...
execute store result storage ic:mob health double 1.5 run random value 50..100
...
execute if score $mainhand ic.int matches 2 run data modify storage ic:mob mainhand set value '{id:"minecraft:diamond_sword",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:knockback":1}}}}'
...
execute if score $offhand ic.int matches 3 run data modify storage ic:mob offhand set value '{id:"minecraft:goat_horn",count:1,components:{"minecraft:attribute_modifiers":[{id:"armor",type:"generic.attack_knockback",amount:4,operation:"add_value",slot:"offhand"}]}}'
