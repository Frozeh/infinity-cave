...
execute if score #ic.tier ic.int matches 991.. run data merge entity @s {ReapplicationDelay:0,Radius:0f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:80,DurationOnUse:0,Age:0,WaitTime:0,Tags:["ic.ability","ic.marker","ic.legendary"]}
