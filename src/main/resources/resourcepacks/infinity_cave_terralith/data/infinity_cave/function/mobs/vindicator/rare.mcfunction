...
execute store result storage ic:mob knockback double 0.0025 run random value 35..70
...
data modify storage ic:mob mob set value vindicator
data modify storage ic:mob Name set value '{"text":"Vindicator"}]'
...
execute if score $mainhand ic.int matches 2 run data modify storage ic:mob mainhand set value '{id:"minecraft:stone_sword",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:sharpness":3}}}}'
