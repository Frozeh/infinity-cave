...
data modify storage ic:mob mainhand set value '{id:"minecraft:crossbow",count:1,components:{"minecraft:custom_model_data":1,"minecraft:unbreakable":{},"minecraft:enchantments":{levels:{"minecraft:quick_charge":1,"minecraft:multishot":5}}}}'
...
execute if score $offhand ic.int matches 2 run data modify storage ic:mob offhand set value '{id:"minecraft:firework_rocket",count:99,components:{"minecraft:fireworks":{explosions:[{shape:"small_ball"},{shape:"small_ball"},{shape:"small_ball"},{shape:"small_ball"},{shape:"small_ball"},{shape:"small_ball"},{shape:"small_ball"},{shape:"small_ball"},{shape:"small_ball"},{shape:"small_ball"},{shape:"small_ball"},{shape:"small_ball"},{shape:"small_ball"},{shape:"small_ball"}]}}}'
