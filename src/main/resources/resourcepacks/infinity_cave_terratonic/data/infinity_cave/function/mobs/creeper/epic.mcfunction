data modify storage ic:mob head set value '{id:"minecraft:diamond_helmet",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:blast_protection":20,"infinity_cave:technical/explosion_immunity":1,"minecraft:protection":4}}}}'
...
execute store result storage ic:mob health double 1.15 run random value 60..120
...
execute store result storage ic:mob scale double 0.01 run random value 75..150
...
data modify storage ic:mob mainhand set value '{id:"minecraft:tnt",count:1}'
