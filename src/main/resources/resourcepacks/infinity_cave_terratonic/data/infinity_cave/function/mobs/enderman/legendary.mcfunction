execute store result storage ic:mob health double 1.2 run random value 75..150
...
data modify storage ic:mob mainhand set value '{id:"minecraft:diamond_sword",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:sharpness":5}}}}'
