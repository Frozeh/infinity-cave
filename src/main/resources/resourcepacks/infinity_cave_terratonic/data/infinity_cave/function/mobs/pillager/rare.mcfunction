...
data modify storage ic:mob mainhand set value '{id:"minecraft:crossbow",count:1,components:{"minecraft:unbreakable":{},"minecraft:enchantments":{levels:{"minecraft:multishot":1,"minecraft:quick_charge":3}}}}'
...
execute if score $offhand ic.int matches 3 run data modify storage ic:mob offhand set value '{id:"minecraft:tipped_arrow",count:99,components:{"minecraft:potion_contents":{custom_color:6946770,custom_effects:[{id:"minecraft:instant_damage",amplifier:1,duration:10},{id:"minecraft:wither",amplifier:2,duration:100},{id:"minecraft:blindness",amplifier:2,duration:100}]}}}'
