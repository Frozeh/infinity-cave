...
execute store result storage ic:mob health double 1.5 run random value 20..40
...
execute if score $offhand ic.int matches 3 run data modify storage ic:mob offhand set value '{id:"minecraft:goat_horn",components:{"minecraft:attribute_modifiers":[{id:"armor",type:"generic.attack_knockback",amount:3,operation:"add_value",slot:"offhand"}]}}'
