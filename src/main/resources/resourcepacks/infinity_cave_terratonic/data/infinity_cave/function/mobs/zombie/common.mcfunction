...
execute if score $mainhand ic.int matches 2 run data modify storage ic:mob mainhand set value '{id:"minecraft:wooden_pickaxe",count:1}'
execute if score $mainhand ic.int matches 3 run data modify storage ic:mob mainhand set value '{id:"minecraft:wooden_shovel",count:1}'
