...
data modify storage ic:mob mainhand set value '{id:"minecraft:netherite_axe",count:1,components:{"minecraft:custom_model_data":1,"minecraft:enchantments":{levels:{"minecraft:sharpness":3}}}}'
