...
execute store result storage ic:mob health double 0.75 run random value 60..120
...
data modify storage ic:mob mainhand set value '{id:"minecraft:blaze_rod",count:1}'
